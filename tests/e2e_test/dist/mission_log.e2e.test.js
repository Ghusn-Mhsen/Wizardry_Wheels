...
describe('Mission Log API E2E Tests', function () {
    it('should fetch mission logs successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res, log;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1["default"](app).get('/api/v1/mission-log')];
                case 1:
                    res = _a.sent();
