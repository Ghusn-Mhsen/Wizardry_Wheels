...
class MoverRoutes {
    ...
    initializeRoutes() {
         ...
         *                       example: 0
         */
        this.router.post("/", MoverValidationRules_1.createMoverValidationRules, validationMiddleware_1.validateRequest, (req, res) => this.MoverController.create(req, res));
        /**
         * @swagger
         ...
         */
        this.router.post("/start-mission", MoverValidationRules_1.startMissionValidationRules, validationMiddleware_1.validateRequest, (req, res) => this.MoverController.startMission(req, res));
        /**
         * @swagger
         * /api/v1/movers/load:
         *   post:
         ...
         *                       example: 1
         */
        this.router.post("/load", MoverValidationRules_1.loadMoverValidationRules, validationMiddleware_1.validateRequest, (req, res) => this.MoverController.load(req, res));
        /**
         * @swagger
         ...
         *                       example: 2
         */
        this.router.post("/end-mission", MoverValidationRules_1.endMissionValidationRules, validationMiddleware_1.validateRequest, (req, res) => this.MoverController.endMission(req, res));
        /**
         * @swagger
         * /api/v1/movers:
         *   get:
